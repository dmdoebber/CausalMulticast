...
public class CausalOrder {
    ...
    private void ver_entrega_Buffer() {
        for(int i = this.Mensagens.size()-1; i >= 0 ;i--){
            ...
            if(this.verificar_Relogio(b.getVetorAtual(), b.getIdUsr()) && !b.isEntregue()) {
                b.setEntregue(true);
                String m = b.getUsr() + ": " + b.getMsg() + "\n";
    ...
    */
    ...
    public void imprimirVetor() {
        for(int i = 0;  i < this.Vetor_rel.length; i++){
            System.out.print(this.Vetor_rel[i]);
        }
    }
